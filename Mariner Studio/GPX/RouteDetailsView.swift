...
//            Path { path in
//                path.move(to: CGPoint(x: 0, y: -30))      // Tip at top
//                path.addLine(to: CGPoint(x: -4, y: -22))  // Left wing
//                path.addLine(to: CGPoint(x: -1.5, y: -22)) // Left side of notch (matches shaft width)
//                path.addLine(to: CGPoint(x: -1.5, y: -18)) // Left shaft connection
//                path.addLine(to: CGPoint(x: 1.5, y: -18))  // Right shaft connection
//                path.addLine(to: CGPoint(x: 1.5, y: -22))  // Right side of notch (matches shaft width)
//                path.addLine(to: CGPoint(x: 4, y: -22))    // Right wing
//                path.closeSubpath() // Closes back to the tip
//            }
//            .fill(Color.red)
//            
