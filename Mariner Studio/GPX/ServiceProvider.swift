...
//    let mapOverlayService: MapOverlayDatabaseService // NEW SERVICE
//    
...
//        self.mapOverlayService = MapOverlayDatabaseService(databaseCore: databaseCore) // NEW SERVICE
//        print("📦 ServiceProvider: Initialized all database services including MapOverlayDatabaseService.")
//        
...
//                try await self.mapOverlayService.initializeMapOverlaySettingsTableAsync() // NEW TABLE INITIALIZATION
//                
