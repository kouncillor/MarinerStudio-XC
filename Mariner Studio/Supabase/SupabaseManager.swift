    ...
    func signIn(email: String, password: String) async throws -> Session {
        ...
        do {
            ...
            logQueue.async {
                ...
                DebugLogger.shared.log("   User authenticated successfully", category: "SUPABASE_AUTH")
                DebugLogger.shared.log("   Email verification complete", category: "SUPABASE_AUTH")
    ...
    func getSession() async throws -> Session {
        ...
        do {
            ...
            logQueue.async {
                ...
                DebugLogger.shared.log("   Session validated", category: "SUPABASE_AUTH")
                DebugLogger.shared.log("   User identity confirmed", category: "SUPABASE_AUTH")
    ...
    func upsertEmbeddedRoute(_ route: RemoteEmbeddedRoute) async throws {
        ...
        do {
            logQueue.async {
                ...
                DebugLogger.shared.log("📤🛣️ ROUTE_INSERT: User authenticated", category: "SUPABASE_ROUTES")
            ...
            logQueue.async {
                ...
                DebugLogger.shared.log("✅📤🛣️ ROUTE_INSERT_SUCCESS: Route '\(route.name)' added successfully", category: "SUPABASE_ROUTES")
