...
//               .padding(.top)
//           
//           // Show current layer count (excluding Layer 0 which is hidden)
//           Text("Showing \(viewModel.selectedChartLayers.count - 1) of 14 layers")
//               .font(.caption)
//               .foregroundColor(.secondary)
//               .padding(.horizontal)
//           
//           // Chart Layers List (exclude Layer 0)
//           List {
...
//               }
//           }
//           .frame(height: 400) // Increased height since we removed other elements
//           .listStyle(PlainListStyle())
//           
//           Divider()
//           
