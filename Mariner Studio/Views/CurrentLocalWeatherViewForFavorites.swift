...
// Icon source enum for favorites
enum IconSourceForFavorites {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            if forecasts.isEmpty {
                ...
                ForEach(forecasts) { forecast in
                    DailyForecastRowViewForFavorites(
                        forecast: forecast,
...
struct ForecastHeaderRowForFavorites: View {
    var body: some View {
        HStack {
            Text("Date")
...
struct DailyForecastRowViewForFavorites: View {
