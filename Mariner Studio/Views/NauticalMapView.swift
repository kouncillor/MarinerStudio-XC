...
struct NauticalMapView: View {
    ...
    private func updateChartOverlay() {
        ...
        let newOverlay = serviceProvider.noaaChartService.createChartTileOverlay(chartType: .traditional, maxLayers: currentLayerCount)
        chartOverlay = newOverlay
    ...
    private func setupChartDisplay() {
        ...
        // Create NOAA chart overlay with current settings
        let overlay = serviceProvider.noaaChartService.createChartTileOverlay(chartType: .traditional, maxLayers: currentLayerCount)
        chartOverlay = overlay
